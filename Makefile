...
KBUILD_CFLAGS += -I/home/abbas/kernel-ml/include

kml-objs := ../../../src/kml_kernel.o ../../../src/optimizers/sgd_optimizer.o ../../../src/models/model.o ../../../src/models/xor_net.o ../../../src/models/linear_regression.o ../../../src/models/ioscheduler_net_classification.o ../../../src/models/ioscheduler_net_data.o ../../../src/math/linear_algebra.o ../../../src/math/matrix.o ../../../src/math/math.o ../../../src/lib/kml_lib.o ../../../src/lib/kml_memory_allocator.o ../../../src/autodiff/autodiff.o ../../../src/utility/utility.o ../../../src/layers/layers.o ../../../src/layers/linear.o ../../../src/layers/sigmoid.o ../../../src/functions/cross_entropy_loss.o ../../../src/functions/square_loss.o ../../../src/functions/binary_cross_entropy_loss.o ../../../src/functions/loss.o ../../../kernel-interfaces/io_scheduler_linear.o ../../../kernel-interfaces/ioscheduler/ioscheduler.o
...
CFLAGS_ioscheduler_net_classification.o := -DKML_KERNEL
CFLAGS_REMOVE_ioscheduler_net_classification.o += -mno-sse2
CFLAGS_REMOVE_ioscheduler_net_classification.o += -mno-sse
CFLAGS_REMOVE_ioscheduler_net_classification.o += -mno-mmx
CFLAGS_ioscheduler_net_data.o := -DKML_KERNEL
CFLAGS_REMOVE_ioscheduler_net_data.o += -mno-sse2
CFLAGS_REMOVE_ioscheduler_net_data.o += -mno-sse
CFLAGS_REMOVE_ioscheduler_net_data.o += -mno-mmx
...
CFLAGS_ioscheduler.o := -DKML_KERNEL
CFLAGS_REMOVE_ioscheduler.o += -mno-sse2
CFLAGS_REMOVE_ioscheduler.o += -mno-sse
CFLAGS_REMOVE_ioscheduler.o += -mno-mmx
